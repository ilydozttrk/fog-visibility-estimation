...
from src.training.cidet_balanced_dataloader import create_cidet_balanced_dataloaders
...
CIDET_BLOCK5_CHECKPOINT_PATH = (
    ...
    / "results"
    / "checkpoints"
    / "vgg16_cidet_block5_balanced_best.pth"
)
...
def save_checkpoint(
    ...
    checkpoint = {
        ...
        "fine_tuning_strategy": "VGG16 Block 5 + regression head + balanced visibility-bin sampling",
        ...
        "sampling_strategy": "inverse visibility-bin frequency",
...
def main() -> None:
    ...
    print("\n=== CIDET VGG16 BLOCK 5 + BALANCED SAMPLING FINE-TUNING ===")
